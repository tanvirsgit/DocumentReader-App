...
<head>
    ...
    <script src="{{ asset('js/node_modules/sweetalert.min.js')}}"></script>
    <script src="{{ asset('js/node_modules/jquery.min.js')}}"></script>
...
<body>
    ...
    <script src="{{ asset('js/includes/resize_canvas.js')}}"></script>
    ...
    <script>
        ...
        var a = document.getElementById("gazeBegin");
